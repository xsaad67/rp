        ...
        <div class="top-bar">
          ...
          <div class="top-bar-list">
            ...
            <div class="top-bar-item top-bar-item-right px-0 d-none d-sm-flex">
                    ...
                    <div class="dropdown-scroll perfect-scrollbar">
                      ...
                      <a href="#!" class="dropdown-item unread">
                        <div class="user-avatar">
                          <img src="/member/images/avatars/uifaces15.jpg" alt="">
                        </div>
                      ...
                      <a href="#!" class="dropdown-item unread">
                        <div class="user-avatar">
                          <img src="/member/images/avatars/uifaces16.jpg" alt="">
                        </div>
                        <div class="dropdown-item-body">
                      ...
                      <a href="#!" class="dropdown-item">
                        <div class="user-avatar">
                          <img src="/member/images/avatars/uifaces17.jpg" alt="">
                        </div>
                        <div class="dropdown-item-body">
                      ...
                      <a href="#!" class="dropdown-item">
                        <div class="user-avatar">
                          <img src="/member/images/avatars/uifaces18.jpg" alt="">
                        </div>
                        <div class="dropdown-item-body">
                      ...
                      <a href="#!" class="dropdown-item">
                        <div class="user-avatar">
                          <img src="/member/images/avatars/uifaces19.jpg" alt="">
                        </div>
                        <div class="dropdown-item-body">
                      ...
                      <a href="#!" class="dropdown-item">
                        <div class="user-avatar">
                          <img src="/member/images/avatars/uifaces20.jpg" alt="">
                        </div>
                        <div class="dropdown-item-body">
                      ...
                      <a href="#!" class="dropdown-item">
                        <div class="user-avatar">
                          <img src="/member/images/avatars/uifaces21.jpg" alt="">
                        </div>
                        <div class="dropdown-item-body">
                ...
                <li class="nav-item dropdown header-nav-dropdown has-notified">
                  ...
                  <div class="dropdown-menu dropdown-menu-rich dropdown-menu-right">
                    ...
                    <div class="dropdown-scroll perfect-scrollbar">
                      ...
                      <a href="#!" class="dropdown-item unread">
                        <div class="user-avatar">
                          <img src="/member/images/avatars/team1.jpg" alt="">
                        </div>
                        <div class="dropdown-item-body">
                      ...
                      <a href="#!" class="dropdown-item">
                        <div class="user-avatar">
                          <img src="/member/images/avatars/team3.png" alt="">
                        </div>
                        <div class="dropdown-item-body">
                      ...
                      <a href="#!" class="dropdown-item">
                        <div class="user-avatar">
                          <img src="/member/images/avatars/team2.png" alt="">
                        </div>
                        <div class="dropdown-item-body">
              ...
              <!-- .btn-account -->
              <div class="dropdown">
                <button class="btn-account d-none d-md-flex" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="user-avatar user-avatar-md"><img src="/member/images/avatars/profile.jpg" alt=""></span> <span class="account-summary pr-lg-4 d-none d-lg-block"><span class="account-name">Beni Arisandi</span> <span class="account-description">Marketing Manager</span></span></button>
