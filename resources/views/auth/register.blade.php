                                ...
                                <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-transparent">
                                            ...
                                            <input type="text" class="form-control" name="name" value="{{old('name')}}" id="input-name" placeholder="Your Name">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-transparent">
                                            ...
                                            <input type="email" name="email" value="{{old('email')}}" class="form-control" id="input-email" placeholder="name@example.com">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-transparent">
                                            ...
                                            <input type="password" class="form-control" name="password_confirmation" id="input-password-confirm" placeholder="********">
                                        </div>
                                    ...
                                    <div class="my-4">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" id="customCheckRegister" type="checkbox" name="tc">
