jQuery(function(l) {
    "use strict";
    var t, a, e, i, n, s, o, r, d, c, u, f, p, v, m, h, g, b;
    if (l('a[href="#"]').on("click", function(t) {
            t.preventDefault()
        }), t = l("body"), a = l(".navbar-sticky"), e = a.outerHeight(), a.length && l(window).on("scroll", function() {
            500 < l(this).scrollTop() ? (a.addClass("navbar-stuck"), a.hasClass("navbar-floating") || t.css("padding-top", e)) : (a.removeClass("navbar-stuck"), t.css("padding-top", 0))
        }), l(".isotope-grid").length) var w = l(".isotope-grid").imagesLoaded(function() {
        w.isotope({
    ...
    if (0 < l(".filter-grid").length) {
        var I = l(".filter-grid");
        l(".nav-tabs").on("click", "a", function(t) {
            t.preventDefault(), l(".nav-tabs a").removeClass("active"), l(this).addClass("active");
    ...
    i = ".search-close", n = ".search-box", l('[data-toggle="search"]').on("click", function() {
        l(n).addClass("is-open"), setTimeout(function() {
            l(n + " input").focus()
        }, 200)
    }), l(i).on("click", function() {
        l(n).removeClass("is-open")
    }), s = "#site-search", l.fn.easyAutocomplete && l(s).easyAutocomplete({
    ...
    }), o = ".offcanvas-container", r = ".offcanvas-close", l('[data-toggle="offcanvas"]').on("click", function(t) {
        var a = l(this).attr("href");
        l(a).addClass("in-view"), t.preventDefault()
    }), l(r).on("click", function() {
        l(o).removeClass("in-view")
    }), d = ".fs-overlay-wrapper", c = ".fs-overlay-close", l('[data-toggle="fullscreen-overlay"]').on("click", function(t) {
        var a = l(this).attr("href");
        l(a).addClass("in-view"), t.preventDefault()
    }), l(c).on("click", function() {
        l(d).removeClass("in-view")
    }), l(document).on("click", ".scroll-to", function(t) {
        var a = l(this).attr("href");
        if ("#" === a) return !1;
        var e = l(a);
        if (0 < e.length) {
            var i = e.data("offset-top") || 75;
            l("html, body").stop().animate({
                scrollTop: l(this.hash).offset().top - i
            }, 1200, "easeOutExpo")
        }
        t.preventDefault()
    }), l('[data-toggle="tooltip"]').tooltip(), l('[data-toggle="popover"]').popover(), M('[data-filter="#components-list"]', ".list-group-item"), M('[data-filter="#components-grid"]', ".card-title"), l(u = ".product-carousel").length && l(u).owlCarousel({
        items: 1,
        loop: !1,
        dots: !1,
        URLhashListener: !0,
    ...
    }), p = ".post-preview-img-carousel", l(f = ".post-cards-carousel").length && l(f).on("change.owl.carousel", function(t) {
        if (t.namespace && "position" === t.property.name) {
            var a = t.relatedTarget.relative(t.property.value, !0);
            l(p).owlCarousel("to", a, 350, !0)
        }
    ...
    }, !1), l(v = ".interactive-credit-card").length && l(v).card({
        form: v,
        ...
        iziToast.show(o)
    }), l(".no-touchevents .team-card-style-1").on("mouseover", function() {
        var t = l(this).find(".social-btn");
        setTimeout(function() {
            t.addClass("hover")
        }, 120)
    }), l(".no-touchevents .team-card-style-1").on("mouseout", function() {
        var t = l(this).find(".social-btn");
        setTimeout(function() {
            t.removeClass("hover")
        }, 120)
    ...
    }), g = "html, body", 0 < l(h = ".scroll-to-top-btn").length && (l(window).on("scroll", function() {
        600 < l(this).scrollTop() ? l(h).addClass("visible") : l(h).removeClass("visible")
    }), l(h).on("click", function() {
        l(g).stop().animate({
            scrollTop: 0
        }, 1200, "easeOutExpo")
    ...
    }), ParallaxScroll.init(), l((b = ".pricing-tabs") + "> li > a").on("click", function(t) {
        var a = l(this),
            e = a.data("period"),
            i = a.parents(".pricing-plans");
        i.find(b + "> li > a").removeClass("active"), a.addClass("active"), i.find(".pricing-card-price").removeClass("active"), i.find("." + e).addClass("active"), t.preventDefault
    });
    var C = l(".google-map");
    C.length && C.each(function() {
        var t = l(this).data("height"),
            ...
            s = l(this).data("marker"),
            o = l(this).data("marker-title"),
